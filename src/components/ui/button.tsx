...
const buttonVariants = cva(
  ...
  primary: "bg-brand text-white hover:bg-brand-dark focus:ring-accent-mint",
  gradient: "bg-brand-gradient dark:bg-brand-gradient-dark text-white hover:opacity-90 dark:hover:opacity-90",
      },
      size: {
